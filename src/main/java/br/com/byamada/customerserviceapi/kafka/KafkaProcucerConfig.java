...
public class KafkaProcucerConfig {
    ...
    //[SPRING SLEUTH] Needed to generate trace id from kafka integrations
    @Bean
    public ProducerFactory<String, String> producerFactory() {
        Map<String, Object> config = createAvroProperties();
...
/* Versão anterior, alterada para resolver problema de tracing Id com sleuth e kafka
package br.com.byamada.customerserviceapi.kafka;
